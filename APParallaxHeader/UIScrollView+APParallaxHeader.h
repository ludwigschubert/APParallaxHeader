...
- (void)addParallaxWithImage:(UIImage *)image andHeight:(CGFloat)height showsShadow:(BOOL)showsShadow;
- (void)addParallaxWithView:(UIView*)view andHeight:(CGFloat)height showsShadow:(BOOL)showsShadow;
